...
class HTTPServer {
public:
    using Handler = std::function<std::string(const std::string&, const std::unordered_map<std::string, std::string>&)>;
    ...
    void start() {
        ...
        io.register_event(server_fd_, IOEvent::Type::READ, [this](int fd, IOEvent::Type) {
